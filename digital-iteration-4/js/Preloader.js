...
GameStates.makePreloader = function( game ) {
    ...
    return {
        ...
        preload: function () {
            ...
            game.load.audio('titleMusic', 'assets/nightinaseashell.mp3');
			game.load.audio('gameMusic', 'assets/thechallenge.mp3');
			...
			game.load.image('redthing','assets/enemy.png');
			game.load.image('field','assets/field2.png');
			game.load.image('fire','assets/fire.png');
			game.load.image('green','assets/green.png');
			game.load.image('gold','assets/playergold.png');
        },
