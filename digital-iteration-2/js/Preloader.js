...
GameStates.makePreloader = function( game ) {
    ...
    return {
        ...
        preload: function () {
			...
			game.load.audio('gameMusic2', 'assets/Komiku Love Planet.mp3');
			game.load.audio('gameMusic3', 'assets/Komiku Surfing.mp3');
			game.load.audio('gameMusic4', 'assets/discocat.mp3');
			game.load.audio('gameMusic5', 'assets/gardenparty.mp3');
			...
			game.load.image('sightChecker','assets/sightcheck.png');
			game.load.image('move','assets/move.png');
			game.load.image('movel','assets/movel.png');
			game.load.image('boolmoveF','assets/boolmoveNO.png');
			game.load.image('boolmovelF','assets/boolmovelNO.png');
			game.load.image('boolmoveT','assets/boolmoveYES.png');
			game.load.image('boolmovelT','assets/boolmovelYES.png');
			game.load.image('star','assets/asterisk.png');
			game.load.image('starF','assets/asteriskNO.png');
        },
